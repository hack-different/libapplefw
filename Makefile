...
pkgdatadir = $(datadir)/libdt
pkgincludedir = $(includedir)/libdt
pkglibdir = $(libdir)/libdt
pkglibexecdir = $(libexecdir)/libdt
...
OTOOL64 = :
PACKAGE = libdt
PACKAGE_BUGREPORT = rickmark@outlook.com
PACKAGE_NAME = libdt
PACKAGE_STRING = libdt 0.1
PACKAGE_TARNAME = libdt
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
RANLIB = ranlib
